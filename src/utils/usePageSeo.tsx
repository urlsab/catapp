...
const seoData: Record<string, PageSeoData> = {
  '/': {
    title: 'בניית אתרים לעסקים | פיתוח אתרים מתקדמים בהתאמה אישית - Catapp',
    description: 'Catapp - בניית אתרים מקצועיים עם React, ביצועים גבוהים וקידום SEO. בניית אתר לעסק קטן, אתר תדמית, חנות אינטרנטית, דף נחיתה. בונה אתרים מומלץ בישראל - פיתוח אתרים, פיתוח אפליקציות ופיתוח תוכנה.',
    schema: {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "בניית אתרים לעסקים | Catapp",
      "description": "בניית אתרים מקצועיים עם React לעסקים בישראל",
      "url": SITE_URL,
  ...
  '/pricing': {
    title: 'מחירון בניית אתרים 2026 | כמה עולה לבנות אתר לעסק קטן - Catapp',
    description: 'מחירון בניית אתרים מעודכן ל-2026: דף נחיתה לעסק מ-2,000₪, אתר תדמית מ-5,000₪, אתר מכירות עם סליקה מ-10,000₪. בניית אתר מחיר שקוף ללא הפתעות. הצעת מחיר לבניית אתר בהתאמה אישית.',
    schema: {
      "@context": "https://schema.org",
      "@type": "WebPage",
  ...
  '/portfolio': {
    title: 'תיק עבודות בניית אתרים | פרויקטים שבנינו ללקוחות - Catapp',
    description: 'תיק עבודות Catapp: אתרים לעורכי דין, אתרים לבעלי עסקים, דפי נחיתה, אתרי תדמית, חנויות אינטרנטיות ופיתוח אפליקציות. צפו בפרויקטים שבנינו עם React ו-Node.js.',
    schema: {
      "@context": "https://schema.org",
      "@type": "CollectionPage",
  ...
  '/about-full': {
    title: 'אודות Catapp | מפתח אתרים בישראל - React פרילנסר מקצועי',
    description: 'Catapp - מפתח React פרילנסר מקצועי בישראל. בניית אתרים בהתאמה אישית עם טכנולוגיות מתקדמות. איך אתר מגדיל הכנסות ומביא לקוחות לעסק שלך. פיתוח אתרים, אפליקציות ותוכנה.',
    schema: {
      "@context": "https://schema.org",
      "@type": "AboutPage",
      "name": "אודות Catapp",
  ...
  '/testimonials': {
    title: 'המלצות לקוחות על בניית אתרים | ביקורות על Catapp',
    description: 'קראו המלצות מלקוחות מרוצים: עורכי דין, בעלי עסקים ומנהלים שבחרו ב-Catapp לבניית אתרים ופיתוח תוכנה. דירוג 5 כוכבים מכל הלקוחות.',
    schema: {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "המלצות לקוחות",
  ...
  '/contact': {
    title: 'צור קשר | הצעת מחיר לבניית אתר לעסק - Catapp',
    description: 'צרו קשר עם Catapp לקבלת הצעת מחיר לבניית אתרים בהתאמה אישית. טלפון: 055-6611594. בונה אתרים לעסקים, עורכי דין ובעלי עסקים. שירות אישי ומהיר.',
    schema: {
      "@context": "https://schema.org",
      "@type": "ContactPage",
      "name": "צור קשר - Catapp",
  ...
  '/faq': {
    title: 'שאלות נפוצות על בניית אתרים | FAQ - Catapp',
    description: 'תשובות לשאלות נפוצות: כמה עולה לבנות אתר? מה ההבדל בין Wix לאתר מותאם אישית? למה React עדיף לעסק? כמה זמן לוקח לבנות אתר? שאלות על קידום SEO ותחזוקה.',
    schema: {
      "@context": "https://schema.org",
      "@type": "FAQPage",
      "mainEntity": [
  ...
  '/quote': {
    title: 'הצעת מחיר לבניית אתר | קבלו הצעה מותאמת - Catapp',
    description: 'קבלו הצעת מחיר מותאמת אישית לבניית אתר לעסק. בניית אתר תדמית, חנות אינטרנטית, דף נחיתה או פיתוח אפליקציה. מלאו את הטופס וקבלו הצעה תוך 24 שעות.',
    schema: {
      "@context": "https://schema.org",
      "@type": "WebPage",
  ...
  '/articles': {
    title: 'מאמרים על בניית אתרים ופיתוח | בלוג Catapp',
    description: 'מאמרים מקצועיים על בניית אתרים, קידום SEO, טכנולוגיות פיתוח, קורות חיים ו-ATS, הנגשת אתרים ועוד. טיפים ומדריכים מעשיים לבעלי עסקים.',
    schema: {
      "@context": "https://schema.org",
      "@type": "Blog",
  ...
  '/ask-ai': {
    ...
    description: 'שאלו את ה-AI של Catapp שאלות על בניית אתרים, פיתוח אתרים, פיתוח אפליקציות, מחירי בניית אתר, קידום בגוגל ועוד. תשובות מיידיות 24/7.',
  },
};
