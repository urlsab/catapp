          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-4">
              ...
              >
                ...
                <span className="text-lg font-semibold">{t('contact.whatsapp')}</span>
              </button>
              ...
              >
                ...
                <span className="text-lg font-semibold">{t('btn.callNow')}</span>
              </button>
              ...
              >
                ...
                <span className="text-lg font-semibold">{t('btn.sendEmail')}</span>
              </button>
              ...
              >
                ...
                <span className="text-lg font-semibold">{t('contact.form')}</span>
              </button>
