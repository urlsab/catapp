...
const knowledgeBase = [
  ...
  },
  {
    ...
    answer: 'אנו מציעים: בניית אתרים (דפי נחיתה, אתרי תדמית, חנויות, בלוגים, רשתות חברתיות, SaaS), תחזוקה חודשית (הגנה מקריסות, קידום SEO, עדכון תכנים), וכן שירותי קורות חיים והעצמת פרופיל LinkedIn.'
  },
];
