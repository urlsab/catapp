...
const benefits = [
  {
    ...
    description: 'לקוחות מחפשים עסקים בגוגל לפני שהם פונים ישירות. אתר מקצועי עם SEO מובנה מביא פניות חדשות גם כשאתם לא ליד הטלפון.',
  },
  {
    icon: Shield,
    title: 'אמינות ומקצועיות',
    description: 'עסק עם אתר מקצועי נראה אמין יותר ממתחרה ללא נוכחות דיגיטלית. זו הרשמת הפנים הדיגיטלית הראשונה שלקוחות רואים.',
  },
  {
    icon: TrendingUp,
    title: 'גידול בפניות',
  ...
  },
  {
    ...
    description: 'רוב הגלישה היא ממובייל. האתר שלכם יעבוד מושלם על כל מכשיר ויטען מהיר — חיוני גם לחוויית המשתמש וגם לדירוג בגוגל.',
  },
];
